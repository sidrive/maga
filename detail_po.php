	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-usd ico-white"></i>PO Suplier</h2>
    ...
    if (isset($_SESSION['items'])) {
        foreach ($_SESSION['items'] as $key => $val) {
            ...
            ?>
				...
				<td><center><Input type="number" name="val" value="<?php echo number_format($val); ?>"></center></td>
				...
				if($total == 0){
					...
					echo '
						...
						<a href="simpanpo.php" class="btn btn-success"><i class="glyphicon glyphicon-shopping-cart icon-white"></i> SIMPAN PO &raquo;</a>
						</div></p>
					';
				}
