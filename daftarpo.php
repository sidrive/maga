...
if(isset($_GET['tglawal'])){
	...
	$query = "SELECT * FROM po WHERE (status_suplier = 'N' OR status_suplier = 'Y') AND tgl_po BETWEEN '$tglawal' AND '$tglakhir' ORDER BY tgl_po DESC";	
}else{
	$query = "SELECT * FROM po WHERE status_kirim = 'N' ORDER BY tgl_po DESC";
}
